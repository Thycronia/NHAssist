    ...
    internal static partial class Bufflib
    {
        ...
        internal static List<(int, float)> GetCalamityBuffStage()
        {
            List<(int, float)> result = new List<(int, float)>
            {
                ...
                (ModContent.BuffType<Cal.Potions.ArmorCrumbling>(), FloatStages.WOF),
                ...
                (ModContent.BuffType<Cal.Potions.AbyssalWeapon>(), BossLib.PostBossStage(ModContent.NPCType<CalNPC.Calamitas.CalamitasClone>())),
                ...
                (ModContent.BuffType<Cal.Potions.HolyWrathBuff>(), FloatStages.MoonLord),
